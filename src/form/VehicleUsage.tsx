...
export default function VehicleUsage() {
  ...
  const onSubmit = (data: VehicleUsageData) => {
    ...
    const annualMiles = data.vehicleOneOneWayDistance
      ? (parseInt(data.vehicleOneOneWayDistance) * 2 * 365).toString()
      : "";
