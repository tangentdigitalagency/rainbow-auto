...
export default function Risk() {
  ...
  const {
    ...
    defaultValues: {
      ...
      driverTwoDUI: formData.driverTwoDUI || "",
    },
  });
  ...
  return (
    ...
    >
      <h2 className="mb-2 text-2xl font-semibold">
        Any bumps in the road for {formData.driverTwoFirstName}?
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  isInvalid={!!errors.driverTwoSuspended}
                  errorMessage={errors.driverTwoSuspended?.message}
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  placeholder="Select an option"
                  isInvalid={!!errors.driverTwoFilingRequired}
                  errorMessage={errors.driverTwoFilingRequired?.message}
                  selectedKeys={field.value ? [field.value] : []}
                >
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select
                  ...
                  placeholder="Select an option"
                  isInvalid={!!errors.driverTwoDUI}
                  errorMessage={errors.driverTwoDUI?.message}
                  selectedKeys={field.value ? [field.value] : []}
                >
