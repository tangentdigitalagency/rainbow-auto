...
export default function VehicleDataTwo() {
  ...
  const onSubmit = (data: VehicleUsageData) => {
    console.log("VehicleDataTwo onSubmit:", data);
    updateFormData({
      ...data,
      lastCompletedStep: "vehicle-data-two",
    });
  ...
  return (
    ...
    >
      <h2 className="mb-2 text-2xl font-semibold">
        How do you use and store your {formData.vehicleTwoMake}{" "}
