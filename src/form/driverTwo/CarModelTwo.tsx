...
export function CarModelTwo() {
  ...
  const onSubmit = (data: CarModelData) => {
    updateFormData({
      vehicleTwoModel: data.model,
      lastCompletedStep: "car-model-two",
    });
    ...
    if (returnTo) {
      ...
      navigate("/vehicle-data-two");
    }
  };

  const handleBack = () => {
    navigate("/car-make-two");
  };
  ...
  return (
    <motion.div
      ...
      variants={fadeIn}
    >
      <h2 className="text-xl font-semibold">What Model is your second car?</h2>
