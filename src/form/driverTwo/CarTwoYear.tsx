...
export function CarYearTwo() {
  ...
  const onSubmit = (data: CarYearData) => {
    updateFormData({
      vehicleTwoYear: data.year,
      lastCompletedStep: "car-year-two",
    });
    ...
    if (returnTo) {
      ...
      navigate("/car-make-two?returnTo=vehicle-profile");
    } else {
  ...
  return (
    <motion.div
      ...
      variants={fadeIn}
    >
      <h2 className="text-xl font-semibold">What year is your second car?</h2>
